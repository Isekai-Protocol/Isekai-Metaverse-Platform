...
(function () {
	...
	window.UEDITOR_CONFIG = {
		...
		, toolbars: [[
			'fullscreen','source','undo', 'redo',"link","unlink",'|',
			...
			'simpleupload', 'insertimage','insertvideo', 'horizontal', 'snapscreen', '|',
		...
		, allowLinkProtocols: ['http:', 'https:', 'self:']
		...
		,whitList: {
			...
			embed: ['type', 'class', 'pluginspage', 'src', 'width', 'height', 'align', 'style', 'wmode', 'play',
				+  'autoplay','loop', 'menu', 'allowscriptaccess', 'allowfullscreen', 'controls', 'preload','poster'],
