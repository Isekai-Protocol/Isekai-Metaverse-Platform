...
use app\common\model\Assembly as AssemblyModel;
...
class Ietask extends Manage
{
    ...
    public function import()
    {
        ...
        $info     = $file->validate(['size' => config('jshop.upload_filesize'), 'ext' => 'csv,xlsx'])->move($savepath);
    ...
    public function importPart()
    {
        ...
        $assembly_mod = new AssemblyModel();
        ...
        if ($info) {
            ...
            return $assembly_mod->exec(json_encode($params));
        } else {
            // 上传失败获取错误信息
            $result['msg'] = $file->getError();
        }
    ...
    public function importRole()
    {
        ...
        if ($info) {
            ...
            return $role_mod->exec(json_encode($params));
        } else {
            // 上传失败获取错误信息
            $result['msg'] = $file->getError();
        }
